...
let text = document.querySelector('.text-my-card')
text.addEventListener('click', function () {if (style.display == 'block') {
    style.display.innerHTML = 'none'
} else {
    style.display.innerHTML = 'block'
}})
